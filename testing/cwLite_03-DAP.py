...
if TEST == 0:
    ...
    gc.set_range("repeat", 30, 50)
    # if PARAMETER_MODEL < 2:
    #     gc.set_range("repeat", 5, 15)
    # else:
    #     gc.set_range("width", 40, 50)
    ...
    # gc.set_range("ext_offset", 102500, 200000) # number of clock cycles to wait before glitching based on the clock of the CW. These values were measured thanks to the previous traces on the oscilloscope.
    gc.set_range("ext_offset", 102500, 104500)
...
if TEST == 1:
    ...
    for glitch_setting in gc.glitch_values():
        ...
        if PARAMETER_MODEL == 0:
            ...
            print(f"ext_offset: {scope.glitch.ext_offset}, width: {scope.glitch.width}")
        print("*-----------------------------------*")
